...
if __name__ == "__main__":
    directory_path = "/Users/daviddawson/Library/Mobile Documents/com~apple~CloudDocs/Documents/projects/mi_capital/source"  # Replace with the path to your directory
